cask "calen" do
  version "0.3.4"
  sha256 "cdfa515d7c8cef92feca273f9b801027874272591d7cd4746d6fed0f9567f5ab"

  url "https://github.com/oyeong011/Planit/releases/download/v0.3.4/Calen-0.3.4-universal.zip"
  name "Calen"
