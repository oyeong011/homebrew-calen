cask "calen" do
  version "0.2.6"
  sha256 "e85c0bca8f399d995f88ab0a27a70f00c5737c2e4fdd7d65805106d3192244a6"

  url "https://github.com/oyeong011/Planit/releases/download/v0.2.6/Calen-0.2.6-universal.zip"
  name "Calen"
